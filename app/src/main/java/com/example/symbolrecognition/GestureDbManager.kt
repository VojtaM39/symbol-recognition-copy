...
class GestureDbManager
{
    private val dbName = "JSAContacts"
    private val dbTable = "Gestures"
    private val colId = "Id"
    private val colContactId = "contact_id"
    private val dbVersion = 1

    private val CREATE_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " + dbTable + " (" + colId + " INTEGER PRIMARY KEY," + colContactId + " INT);"
