...
class ContactActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            if (id != 0) {
                edtName.setText(bundle.getString("MainActTitle"))
                edtPhoneNumber.setText(bundle.getString("MainActContent"))
            }
        } catch (ex: Exception) {
        }
        ...
        btnSave.setOnClickListener {
            ...
            values.put("Title", edtName.text.toString())
            values.put("Content", edtPhoneNumber.text.toString())
